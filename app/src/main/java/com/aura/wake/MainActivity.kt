...
import com.aura.wake.ui.home.HomeScreen
import com.aura.wake.ui.theme.AllarmAppTheme
            ...
            AllarmAppTheme(darkTheme = true) {
                ...
                NavHost(navController = navController, startDestination = startDestination) {
                    ...
                    composable("overlay_settings") {
                        com.aura.wake.ui.menu.OverlaySettingsScreen(navController = navController)
                    }
                    composable("contribution") {
                        com.aura.wake.ui.menu.ContributionScreen(navController = navController)
                    }
                    ...
                    composable("mission_customization") { 
                        com.aura.wake.ui.mission.MissionCustomizationListScreen(navController = navController)
                    }
                    composable("mission_settings/{type}") { backStackEntry ->
                        val typeStr = backStackEntry.arguments?.getString("type")
                        val type = try {
                            com.aura.wake.data.model.ChallengeType.valueOf(typeStr ?: "")
                        } catch (e: Exception) {
                            com.aura.wake.data.model.ChallengeType.MATH
                        }
                        ...
                        when (type) {
                            com.aura.wake.data.model.ChallengeType.MATH -> 
                                com.aura.wake.ui.mission.MathMissionSettingsScreen(navController = navController)
                            com.aura.wake.data.model.ChallengeType.TYPING ->
                    ...
                    composable("overlay_permission") {
                     ...
                     navigation(startDestination = "welcome", route = "onboarding") {
                         composable("welcome") {
                             com.aura.wake.ui.onboarding.WelcomeScreen(
                         ...
                         composable("time") { backStackEntry ->
                             ...
                             val onboardingViewModel: com.aura.wake.ui.onboarding.OnboardingViewModel = androidx.lifecycle.viewmodel.compose.viewModel(
                                 viewModelStoreOwner = parentEntry,
                                 factory = AppViewModelProvider.Factory
                             )
                             com.aura.wake.ui.onboarding.OnboardingTimeScreen(
                         ...
                         composable("sound") { backStackEntry ->
                             ...
                             com.aura.wake.ui.onboarding.OnboardingSoundScreen(
                                 viewModel = onboardingViewModel,
                         ...
                         composable("mission") { backStackEntry ->
                             ...
                             com.aura.wake.ui.onboarding.OnboardingMissionScreen(
                                 viewModel = onboardingViewModel,
                                 onNext = { navController.navigate("permission") }
                             )
                         }
                         composable("permission") {
                             com.aura.wake.ui.onboarding.OnboardingPermissionScreen(
                         ...
                         composable("setup") { backStackEntry ->
                             ...
                             com.aura.wake.ui.onboarding.OnboardingSetupScreen(
                                 viewModel = onboardingViewModel,
                                 onComplete = {
                                     navController.navigate("home") {
                    ...
                    composable("create_alarm") {
                        com.aura.wake.ui.alarm.AlarmScreen(navController = navController)
                    }
                    composable("edit_alarm/{alarmId}") { backStackEntry ->
                        val alarmId = backStackEntry.arguments?.getString("alarmId")
                        com.aura.wake.ui.alarm.AlarmScreen(navController = navController, alarmId = alarmId)
                    }
                    composable(
                        ...
                        com.aura.wake.ui.ring.AlarmRingingScreen(
